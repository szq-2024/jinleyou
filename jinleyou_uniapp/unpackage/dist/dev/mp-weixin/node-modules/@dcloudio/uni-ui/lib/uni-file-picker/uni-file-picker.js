...
const _sfc_main = {
  ...
  created() {
    if (!(common_vendor.nr.config && common_vendor.nr.config.provider)) {
      this.noSpace = true;
      common_vendor.nr.chooseAndUploadFile = common_vendor.chooseAndUploadFile;
    }
  ...
  methods: {
    ...
    chooseFiles() {
      ...
      common_vendor.nr.chooseAndUploadFile({
        ...
        common_vendor.index.__f__("log", "at node_modules/@dcloudio/uni-ui/lib/uni-file-picker/uni-file-picker.vue:364", "选择失败", err);
      });
    },
    /**
     * 选择文件回调
    ...
    uploadFiles(files) {
      ...
      return common_vendor.uploadCloudFiles.call(this, files, 5, (res) => {
        ...
        common_vendor.index.__f__("log", "at node_modules/@dcloudio/uni-ui/lib/uni-file-picker/uni-file-picker.vue:437", err);
      });
    },
    /**
     * 成功或失败
